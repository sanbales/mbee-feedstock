...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-mbee-green.svg)](https://anaconda.org/conda-forge/mbee) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/mbee.svg)](https://anaconda.org/conda-forge/mbee) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/mbee.svg)](https://anaconda.org/conda-forge/mbee) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/mbee.svg)](https://anaconda.org/conda-forge/mbee) |

Installing mbee
===============

Installing `mbee` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:

```
conda config --add channels conda-forge
```

Once the `conda-forge` channel has been enabled, `mbee` can be installed with:
...
```
conda search mbee --channel conda-forge
```
